...
def goalCalsCalc():
	...
	height = float(str(heightFile2.read()))
	ageFile2 = open("age.txt", "r")
	age = float(str(ageFile2.read()))
	mORfFile2 = open("mORf.txt", "r")
	mORf = mORfFile2.read()
	alFile2 = open("al.txt", "r")
	al = int(str(alFile2.read()))
...
def submitStats():
	...
	try:
		with open("height.txt", "w") as myfile:
			myfile.write(str(float(heightEntry1.get())))
		with open("al.txt", "w") as myfile:
			myfile.write(str(int(aLEntry1.get())))
		with open("age.txt", "w") as myfile:
			myfile.write(str(float(ageEntry1.get())))
		with open("data.txt", "a") as myfile:
			myfile.write("\n"+str(float(weightEntry1.get())))
...
def chartUpdate():
	...
	for i in range(len(data) - 1 - 10, len(data),1):
		...
		c.create_text(x0-15, y0, anchor='sw', text=str(int(data[i])), font=("System", 18), fill='white')
		ctr = ctr + 1
...
style2.configure("2orange.TButton", background='#ff8f00', font=("System", 20))
style2.configure("transp.TLabel", font=("System", 20), foreground='black', background='white')
style2.configure("transp1.TLabel", font=("System", 10), foreground='black', background='white')
...
#Age
ageEntry1 = Entry(root2, width=15,style='2orange.horizontal.TEntry',font=("System", 20))
...
#Height
heightEntry1 = Entry(root2, width=15,style='2orange.horizontal.TEntry',font=("System", 20))
...
#Gender
gEntry1 = Entry(root2, width=15,style='2orange.horizontal.TEntry',font=("System", 20))
...
#Activity Level
aLEntry1 = Entry(root2, width=15,style='2orange.horizontal.TEntry',font=("System", 20))
...
#Weight
weightEntry1 = Entry(root2, width=15,style='2orange.horizontal.TEntry',font=("System", 20))
...
style.configure("orange.TButton", background='#ff8f00', font=("System", 20))
style.configure("orange.Horizontal.TProgressbar", background='#ff8f00')
style.configure("transp.TLabel", font=("System", 20), foreground='black' )
style.configure("norm.TLabel", font=("System", 20), foreground='black', bg='white')
...
weightEntry = Entry(root, width=15,style='orange.horizontal.TEntry',font=("System", 20))
...
#Type your cals here
calsEntry = Entry(root, width=15,style='orange.horizontal.TEntry',font=("System", 20))
